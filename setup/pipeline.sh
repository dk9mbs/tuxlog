...
USERNAME=$($PYTHON ./cfgreader.py $CFG_FILE mysqlcfg username)
PASSWORD=$($PYTHON ./cfgreader.py $CFG_FILE mysqlcfg password)
HOST=$($PYTHON ./cfgreader.py $CFG_FILE mysqlcfg host)
BASEDIR=$(dirname "$0")
